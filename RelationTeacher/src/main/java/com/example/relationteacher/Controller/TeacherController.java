...
public class TeacherController {
    ...
    public ResponseEntity getAllTeacherById(@PathVariable Integer id){
        teacherService.getAllTeacherById(id);
        return ResponseEntity.status(200).body("get Address to Teacher By Id");
    }
}
